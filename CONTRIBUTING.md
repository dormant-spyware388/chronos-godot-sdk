...
This repo is for **Godot SDK-specific work only**.

Good contributions:

- SDK bug fixes
- Godot compatibility improvements (3.6 / 4.x)
- installation/setup improvements
- example scene improvements
...
- AI / Brain behavior changes
- product roadmap proposals
- non-Godot SDK features
...
Godot SDK → client integration layer
